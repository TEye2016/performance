package chzu.performance.sercurity;
...
import chzu.performance.util.Common;
...
public class MyAuthenticationFilter extends
	 ...
	 * 登录成功后跳转的地址
	 */
	private String successUrl = "/performance/WEB-INF/view/main.jsp";
	/**
	 * 登录失败后跳转的地址
	 */
	private String errorUrl = "/background/login.jsp";
	@Autowired
	private UserMapper userDao;
	@Autowired
	private UserService userLoginListService;

	/**
	 * 自定义表单参数的name属性，默认是 j_username 和 j_password 定义登录成功和失败的跳转地址
	 * 
	 * @author LRH Email: lrhtomcat@163.com
	 * @date 2016-6-10 下午2:45:32
	 */
	public void init() {
	...
	public Authentication attemptAuthentication(HttpServletRequest request,
		...
		User users;
		users = this.userDao.querySingleUser(u);
		if (users == null) {
			BadCredentialsException exception = new BadCredentialsException(
