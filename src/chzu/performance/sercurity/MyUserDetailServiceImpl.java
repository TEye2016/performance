...
//		System.err.println("-----------MyUserDetailServiceImpl loadUserByUsername ----------- ");
		...
		//取得用户的权限
		chzu.performance.entity.User users = userDao.querySingleUserByName(username);
		if  (users==null)  
	...
	// 取得用户的权限
	private Set<GrantedAuthority> obtionGrantedAuthorities(chzu.performance.entity.User user) {
