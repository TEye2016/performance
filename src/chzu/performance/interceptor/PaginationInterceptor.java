...
import chzu.performance.util.Dialect;
import chzu.performance.util.MySql5Dialect;
import chzu.performance.util.Page;
import chzu.performance.util.PageContext;
import chzu.performance.util.ReflectHelper;
...
public class PaginationInterceptor implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		MappedStatement mappedStatement = (MappedStatement) invocation
				.getArgs()[0];
		String id = mappedStatement.getId().toUpperCase();
		if (id.endsWith("PAGE")) {
