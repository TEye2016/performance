...
<body>
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/lib/layer1.8/layer.min.js"></script>
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/lib/laypage/laypage.js"></script>
	<script type="text/javascript"
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/H-ui.admin.doc.js"></script>
	<script
		src="${pageContext.request.contextPath }/lib/laypage/laypage.js"></script>
	<script type="text/javascript">
		$(function() {
			...
			var thisDate = function(curr) {
				...
				for (var i = (curr * nums - nums); i <= last; i++) {
					str += "<tr class='text-c'>"
							...
							+ "<td>"
							+ r[i].resurl
							+ "</td><td class='f-14 article-manage'> <a style='text-decoration: none' class='ml-5'"
							+ "onClick='resource_edit("+r[i].id+")' href='javascript:;' title='修改'><i class='icon-edit'></i></a>"
